...
The augmented-democracy architecture of \nc\ places governance bodies
at multiple $G$-levels in interaction:
\begin{itemize}
\item A $G_2$ committee (the NC tech committee) makes product
...
\item Customer organizations are themselves $G_3$ bodies operating on
  the NC platform; their internal $G_2$ committees use the same
...
\item All of the above are subject to $G_5$ jurisdictional law
  (Quebec / Canada) via the $G_3$ corporation's
